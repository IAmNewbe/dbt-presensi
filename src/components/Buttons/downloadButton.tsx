...
const DownloadButton: React.FC = () => {
  ...
  return (
    ...
    className="hover:bg-blueeazy hover:text-white inline-flex items-center justify-center gap-2.5 border border-blueeazy p-2 text-center font-medium text-blueeazy hover:bg-opacity-90 rounded-md"
    >
    <span>
      <svg
