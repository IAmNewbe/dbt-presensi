...
import Eazy from '../../images/logo/logo-white.svg';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
 ...
 const handleLogout = () => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-60 flex-col overflow-y-hidden bg-blueeazy duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className="flex ">
          <h1 className='hidden font-bold text-lg text-white font-satoshi float-left'>Attendace Admin Dashboard</h1>
          <img src={Eazy} className=''></img>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark duration-300 ease-in-out hover:bg-white hover:text-blueeazy dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'bg-white text-blueeazy dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-white hover:text-blueeazy dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-white text-blueeazy dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`hidden group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
